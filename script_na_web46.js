...
function init(){
        ...
        scene.add( helper );
        //const helper02 = new THREE.CameraHelper( spotLight.shadow.camera );
        const helper02 = new THREE.SpotLightHelper( spotLight02 );
        helper02.color = 0x00ff00
        scene.add( helper02 );
        //const helper03 = new THREE.CameraHelper( spotLight.shadow.camera );
        //const helper03 = new THREE.SpotLightHelper( spotLight03 );
        const helper03 = new THREE.CameraHelper( spotLight03 );
        helper03.color = 0x0000ff
        scene.add( helper03 );
