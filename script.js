...
const bakedTextureEmpty = textureLoader.load('../static/baked_empty.jpg')
bakedTextureEmpty.flipY = false
bakedTextureEmpty.encoding = THREE.sRGBEncoding

const bakedTextureNutty = textureLoader.load('../static/baked_nutty.jpg')
bakedTextureNutty.flipY = false
bakedTextureNutty.encoding = THREE.sRGBEncoding

const bakedTextureJesus = textureLoader.load('../static/baked_jesus.jpg')
bakedTextureJesus.flipY = false
bakedTextureJesus.encoding = THREE.sRGBEncoding

const bakedTextureSandy = textureLoader.load('../static/baked_sandy.jpg')
bakedTextureSandy.flipY = false
bakedTextureSandy.encoding = THREE.sRGBEncoding

const bumpTexture = textureLoader.load('../static/bake_bump.jpg')
bumpTexture.flipY = false
bumpTexture.encoding = THREE.sRGBEncoding


//Short sleeve textures
const bakedTextureWhitee = textureLoader.load('../static/baked_whitee.jpg')
bakedTextureWhitee.flipY = false
bakedTextureWhitee.encoding = THREE.sRGBEncoding

const bumpTextureShort = textureLoader.load('../static/baked_short_sleeve_bump.jpg')
...
let dresMesh
gltfLoader.load('../../static/dres_01.glb', (gltf) =>
    {
        dresMesh = gltf.scene
...
let dresMeshShort
gltfLoader.load('../static/dres_02.glb', (gltf) =>
    {
