...
function init(){
        ...
        bakedTextureJesus.colorSpace = THREE.SRGBColorSpace;

        const bumpTexture = textureLoader.load('https://cdn.jsdelivr.net/gh/rychidesign/thtd-three-setup/assets/bump_long_02.png') //bake_bump_2.jpg
